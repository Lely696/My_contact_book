...
// номеров телефонов по фамилии и поиска фамилии по номеру телефона,а также вывод справочника на экран. Базовый контейнерный класс выбрать самостоятельно.
...
public class Phonebook {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("введите цыфру 1, чтобы добавить данные");
        System.out.println("введите цыфру 2, чтобы удалить данные");
        System.out.println("введите цыфру 3, чтобы найти номера по фамилии");
        System.out.println("введите цыфру 4, чтобы найти фамилию");
        System.out.println("введите цыфру 5, чтобы сохранить");
        System.out.println("введите цыфру 6, чтобы вывести на экран");
        System.out.println("введите цыфру 7, чтобы выйти из программы");
                ...
                if(act.equals("2")){
                    ...
                    if (act.equals("3")){
                        ...
                        if (act.equals("4")) {
                            ...
                            //поиск номеров по фамилии
                            if (act.equals("6")) {
                                System.out.println("Показать все записи:");
                                PrintPhonebook(); }
                            }
                        }
                    }
